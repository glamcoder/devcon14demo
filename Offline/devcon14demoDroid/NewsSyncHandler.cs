...
{
    class NewsSyncHandler : MobileServiceSyncHandler
    {
        ...
        public NewsSyncHandler(Activity activity)
        {
        ...
        public override async Task<JObject> ExecuteTableOperationAsync(IMobileServiceTableOperation operation)
        {
            ...
            do
            {
                ...
                if (error != null)
                {
                    var localItem = operation.Item.ToObject<NewsItem>();
